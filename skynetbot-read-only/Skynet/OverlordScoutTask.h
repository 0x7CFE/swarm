...
{
public:
	OverlordScoutTask(TaskType priority, ScoutData data);
	...
	virtual std::string getTaskName() const { return "Overlord Scout"; }
...
typedef std::tr1::shared_ptr<OverlordScoutTask> OverlordScoutTaskPointer;